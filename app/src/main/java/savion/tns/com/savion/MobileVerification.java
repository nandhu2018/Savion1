...
// Checking for user session
    ...
    class ViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(View collection, int position) {int resId = 0;
            switch (position) {
                case 0:
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_verify_otp:
               ...
               if (inputOtp.getText().toString().equalsIgnoreCase(otp)){
                   ...
                   startActivity(new Intent(MobileVerification.this,MainActivity1.class));
                   finish();
               }else{
                   btnVerifyOtp.setEnabled(true);
